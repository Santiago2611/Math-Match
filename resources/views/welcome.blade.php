...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        ...
        <div class="container px-5 ">
            <a class="navbar-brand" href="{{url('/')}}">Math-Match</a>
            ...
            <div class="row gx-5 align-items-center">
                <div class="col-lg-6">
                    <div class="p-5"><img class="img-fluid rounded-circle" src="{{asset('images/img2.jpg')}}" alt="..." /></div>
                </div>
                <div class="col-lg-6">
                    <div class="p-5">
            ...
            <div class="row gx-5 align-items-center">
                <div class="col-lg-6 order-lg-2">
                    <div class="p-5"><img class="img-fluid rounded-circle" src="{{asset('images/img3.jpg')}}" alt="..." /></div>
                </div>
                <div class="col-lg-6 order-lg-1">
                    <div class="p-5">
